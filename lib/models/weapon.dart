...
const List<Weapon> droppedWeapons = [
  ...
  Weapon(name: 'Flame Cloud Ejector', abbreviation: 'FCE', toHit: '-', damage: '1d-1', dp: 2, cost: 500, weight: 50, space: 2, ammoPerBox: 10, costPerShot: 60, weightPerShot: 5),
  Weapon(name: 'HD Flame Cloud Ejector', abbreviation: 'HDFCE', toHit: '-', damage: '1d-1', dp: 2, cost: 1000, weight: 100, space: 3, ammoPerBox: 10, costPerShot: 240, weightPerShot: 20),
  ...
  Weapon(name: 'Flaming Oil Jet', abbreviation: 'FOJ', toHit: '-', damage: '1d-2', dp: 3, cost: 300, weight: 30, space: 2, ammoPerBox: 25, costPerShot: 35, weightPerShot: 2),
  Weapon(name: 'Heavy Flaming Oil Jet', abbreviation: 'HFOJ', toHit: '-', damage: '1d-2', dp: 4, cost: 550, weight: 60, space: 3, ammoPerBox: 10, costPerShot: 140, weightPerShot: 8),
